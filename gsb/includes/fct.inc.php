...
/**
 * Identifie la variable de session visiteur connecté
 * @return type
 */
function visiteurConnecte(){
    return ($_SESSION['categorie']=='visiteur');
}

/**
 * Identifie la variable de session comptable connecté
 * @return type
 */
function comptableConnecte(){
    return ($_SESSION['categorie']=='comptable');
}
 ...
 * @return null
 */
function connecter($idVisiteur, $nom, $prenom,$categorie)
{
