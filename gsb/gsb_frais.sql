...
--
-- Hôte : 127.0.0.1:3306
-- Généré le :  mar. 06 avr. 2021 à 08:18
...
('a17', '202103', 0, '0.00', '2021-04-03', 'CL'),
('a17', '202104', 0, '0.00', '2021-04-03', 'CR'),
('a55', '202104', 0, '0.00', '2021-04-05', 'CR');
...
(1, 'a17', '202103', 'divertissement', '2021-03-10', '30.00');
...
CREATE TABLE IF NOT EXISTS `visiteur` (
  ...
  `categorie` char(10) DEFAULT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
...
INSERT INTO `visiteur` (`id`, `nom`, `prenom`, `login`, `mdp`, `adresse`, `cp`, `ville`, `dateembauche`, `categorie`) VALUES
...
('cpt1', 'Durand', 'Vincent', 'comptable', 'comptable', NULL, NULL, NULL, NULL, 'comptable'),
